...
public class Toolbar extends Conditions{
    ...
    public void fillFilter(String text){
        ...
        filterInput.clear();
        filterInput.sendKeys(text + Keys.TAB);
    }
...
//----------------------------------------------------------------------------------------------------------------------
    ...
    @FindBy(xpath = "(//div[contains(@id,'choiceButton')])[last()]")
    ...
    @FindBy(xpath = ".//div[contains(@id,'DescriptionFilter')]//input")
    ...
    @FindBy(xpath = "//div[contains(@id,'editButton')]")
